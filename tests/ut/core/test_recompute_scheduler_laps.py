...
class TestRecomputeSchedulerLaps(TestBase):
    ...
    def create_scheduler(self, mock_compute_encoder_budget, **laps_overrides):
    ...
    def test_aged_long_promoted_over_short_after_wait(self):
        ...
        with patch("vllm_ascend.core.laps_scheduler.time", clock):
            # Pure-deadline aging at 100ms (reservation defaults to 0).
            ...
            # Long has aged past its deadline before this scheduling step.
