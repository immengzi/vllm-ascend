...
class ShortRequestFirstAsyncScheduler(AsyncScheduler):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        short_request_first_config = init_ascend_config(self.vllm_config).short_request_first_config
...
class ShortRequestFirstScheduler(Scheduler):
    """Synchronous scheduler that installs the ShortRequestFirst waiting queue."""
