...
start_prefill() {
  ...
  (
    ...
    if [ "${laps_threshold}" = "off" ]; then
      ...
      laps_config_json="\"laps_config\":{\"enabled\":true,\"threshold\":${laps_threshold},\"long_max_wait_ms\":${laps_wait_window_ms},\"stats_log_interval_s\":${LAPS_STATS_LOG_INTERVAL_S}}"
    fi
